...
save_board_figs("Kuvio_17", plot = p, height = fig_height, save_data = TRUE)



save_board_figs("Kuvio_17_en", plot = ggptt::translate_plot(p, fig_translation), height = fig_height, save_data = TRUE)
...
save_board_figs("Kuvio_18", plot = p, height = fig_height, save_data = TRUE)

save_board_figs("Kuvio_18_en", plot = ggptt::translate_plot(p, fig_translation), height = fig_height, save_data = TRUE)

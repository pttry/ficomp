...
var_labels_fi <- c(
  ...
  nulc = "Yksikkötyökustannus, nimellinen",
  nulc_aper = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjattu, henkilöä kohden",
  nulc_aper_va = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjattu, henkilöä kohden, arvonlisästä",
  nulc_hw_va = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjattu, tuntia kohden, arvonlisästä",
  nulc_hw_va_eur = "Yksikkötyökustannus, nimellinen, samassa valuutassa, yrittäjäkorjattu, tuntia kohden, arvonlisästä",
  rulc_hw_va = "Yksikkötyökustannus, reaalinen, omassa valuutassa, yrittäjäkorjattu, tuntia kohden, arvonlisästä",
  nulc_hw_va_rel = "Relative nominal unit labour cost, hours, value added, related to other countries, rolling  double trade weights",
  nulc_hw_va_eur_rel = "Relative nominal unit labour cost, hours, value added, in common currency (EUR), related to other countries, rolling  double trade weights",
  rulc_hw_va_rel = "Relative real unit labour cost, hours, value added, related to other countries, rolling double trade weights",
  XPERF = "Export performance for goods and services, volume",

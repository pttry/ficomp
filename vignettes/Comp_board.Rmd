...
save_board_figs("Kuvio_5_2_en", plot = ggptt::translate_plot(last_plot(), fig_translation), height = fig_height, save_data = TRUE)
...
save_board_figs("Kuvio_5_1_en", plot = ggptt::translate_plot(last_plot(), fig_translation), height = fig_height, save_data = TRUE)

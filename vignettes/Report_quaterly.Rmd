...
data_quartely_est_extra <- data_quartely_est %>% 
...
mb_nulc_aper_eur_long_rel_fast <- MacrobondAPI::CreateTimeSeriesObject(name = "ih:mb:com:nulcefast",
                                     description = "Suomen suhteelliset yksikkötyökustannukset samassa valuutassa, 10 maata", 
                                     region = "fi", 
...
UploadOneOrMoreTimeSeries(list(mb_nulc_aper_eur_long_rel_fast, mb_nulc_aper_eur_long_rel_ecfin20))

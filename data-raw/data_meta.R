...
geo17 <- c(setdiff(eurostat_geos, "UK"), c("US", "JP", "CH"))
...
var_labels_fi <- c(
  ...
  nulc = "Yksikkötyökustannus, nimellinen, omassa valuutassa, ei yrittäjäkorjausta, BKT:sta",
  nulc_va = "Yksikkötyökustannus, nimellinen, omassa valuutassa, ei yrittäjäkorjausta, arvonlisästä",
  nulc_aper = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjaus henkilöistä, BKT:sta",
  nulc_aper_va = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjaus henkilöistä, arvonlisästä",
  nulc_hw = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjaus tunneista, BKT:sta",
  nulc_hw_va = "Yksikkötyökustannus, nimellinen, omassa valuutassa, yrittäjäkorjaus tunneista, arvonlisästä",
  nulc_hw_va_eur = "Yksikkötyökustannus, nimellinen, samassa valuutassa, yrittäjäkorjaus tunneista, arvonlisästä",
  rulc = "Yksikkötyökustannus, reaalinen, omassa valuutassa, ei yrittäjäkorjausta, BKT:sta",
  rulc_va = "Yksikkötyökustannus, reaalinen, omassa valuutassa, ei yrittäjäkorjausta, arvonlisästä",
  rulc_aper = "Yksikkötyökustannus, reaalinen, omassa valuutassa, yrittäjäkorjaus henkilöistä, BKT:sta",
  rulc_aper_va = "Yksikkötyökustannus, reaalinen, omassa valuutassa, yrittäjäkorjaus henkilöistä, arvonlisästä",
  rulc_hw_va = "Yksikkötyökustannus, reaalinen, omassa valuutassa, yrittäjäkorjaus tunneista, arvonlisästä",
  nulc_hw_va_rel = "Relative nominal unit labour cost, hours, value added, related to other countries, rolling  double trade weights",
  nulc_hw_va_eur_rel = "Relative nominal unit labour cost, hours, value added, in common currency (EUR), related to other countries, rolling  double trade weights",
  rulc_hw_va_rel = "Relative real unit labour cost, hours, value added, related to other countries, rolling double trade weights",
  XPERF = "Export performance for goods and services, volume",

...
save_board_figs("Kuvio_5_6", height = fig_height, save_data = TRUE)
...
save_board_figs("Kuvio_5_5", height = fig_height, save_data = TRUE)
...
save_board_figs("Kuvio_6_1", height = fig_height, save_data = TRUE) 

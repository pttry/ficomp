...
# data_main_groups_a %>%
#   filter(nace0 %in% c("total", "private", "private_ex26"),
#          geo == "FI") %>% 
#   select(geo, time, nace0, nulc_aper_va_eur_rel_ecfinnace, rulc_aper_va_rel_ecfinnace, nulc_aper_va_eur, rulc_aper_va) %>%

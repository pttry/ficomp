...
data_quartely_est %>% 
  ...
  labs(title = "Suomen suhteelliset yksikkötyökustannukset samassa valuutassa",
       ...
       lasketut 20 ja 14 maan tietoihin perustuvat indikaattorit",
       y = "indeksi, 2010 = 100", 
...
mb_nulc_aper_eur_long_rel_ecfin14 <- MacrobondAPI::CreateTimeSeriesObject(name = "ih:mb:com:nulcecfin14",
                                     description = "Suomen suhteelliset yksikkötyökustannukset samassa valuutassa, 14 maata", 
                                     region = "fi", 
...
mb_nulc_aper_eur_long_rel_ecfin20 <- MacrobondAPI::CreateTimeSeriesObject(name = "ih:mb:com:nulcecfin20",
                                     description = "Suomen suhteelliset yksikkötyökustannukset samassa valuutassa, 20 maata", 
                                     region = "fi", 
                                     category = "National accounts", 
                                     frequency = "Quarterly", 
...
UploadOneOrMoreTimeSeries(list(mb_nulc_aper_eur_long_rel_ecfin14, mb_nulc_aper_eur_long_rel_ecfin20))
...
q_dat %>% 
  select(time, geo, d1_hw_ind, nulc_hw_va_eur, lp_hw_ind) %>% 
...
data_quartely_est %>% 
  ...
  select(geo, time, nulc_var = nulc_aper_long_rel_ecfin20, gdp_ind_long_rel_ecfin20, exp_ind_long_rel_ecfin20) %>% 
